        ...
        <div class="bag">
            ...
            <form action="">
                ...
                <li>
                    ...
                    <input id="uname" @focus="focus" name="phone" @input="aa"  v-model="phone" type="text" placeholder="请输入您的手机号" autocomplete="off">
                ...
                <li>
                    ...
                    <input id="email" @focus="focus" name="email"  v-model="email" type="text" placeholder="请输入您的邮箱" autocomplete="off">
                    <div class="error" ref="email">{{message2}}</div>
                </li>
                <li>
                    ...
                    <input type="password" @focus="focus"  id="pass" name="pass" v-model="pass" placeholder="在这里输入密码" autocomplete="off">
                </li>
                <li>
                    <div class="user"><img src="../assets/img/pass.png" alt=""></div>
                    <div class="Pcircle"></div>
                    ...
                    <input type="password"  id="pass1" name="pass1"v-model="pass1" placeholder="再次输入密码确认" autocomplete="off">
                </li>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            wancheng(){/*点击提交的事件*/
                var preg=/^(130|131|132|133|135|137|138|139|151|152|155|158|159|178|180|182|183|188)\d{8}$/;
                if(!preg.test(this.phone)){
                    this.$refs.phone.style.display="block";
                    this.message1="该手机号不合法";
                    return;
                }else{
                    this.$refs.phone.style.display="none";
                }
                var pregE=/^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$/;
                if(!pregE.test(this.email)){
                    this.$refs.email.style.display="block";
                    this.message2="该邮箱不合法";
                    return;
                }else{
